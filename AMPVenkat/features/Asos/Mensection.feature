Feature: Asos | Home
  This is to perform automated functional testing of launching and logging in to rei  Website

  Scenario Outline: Asos | Home | explore | Order
    Given I launch the url "https://www.asos.com/"
    Then I should see "AsosLogo"
    And I click "Asos_mensection" button
  ...
  Scenario Outline: Verifying banner and filters available for items
    ...
    Then I verify text of "Asos_F2option1text" as "Validitem2"
